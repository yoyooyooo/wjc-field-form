...
var LabelWrap = styled(Col)(_templateObject2());
var ItemWrap = styled(Col)(_templateObject3());
var Label = styled.label(_templateObject4(), function (p) {
  return p._width || 200;
}, function (p) {
  return p.colon && " &::after {\n      content: ':';\n      display: inline-block;\n    }";
});
var ErrorWrap = styled(animated.div)(_templateObject5());

var Error = function Error(_ref) {
  var children = _ref.children;
  var transitions = useTransition(children.slice(0, 1), function (item, i) {
    return i;
  }, {
    from: {
      opacity: 0,
...
function defaultMapMetaToChildren(_ref4) {
  var validating = _ref4.validating,
      errors = _ref4.errors;
  return {
    suffix: validating ? React.createElement(Icon, {
      type: "loading"
    }) : errors.length > 0 ? React.createElement(Icon, {
      type: "close-circle"
...
var Field = (function (_ref5) {
  ...
  return React.createElement(Field$1, _extends({
    name: name
